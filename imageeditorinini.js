document.addEventListener("presentationstart", (e) => {
    ...
    //     captionResultDiv.textContent = caption.text;
    ...
    //   // Display error message if predictions is not an array
    //   if (!Array.isArray(predictions)) {
    //     resultDiv.textContent = "Unexpected response format.";
    //     return;
    //   }
    
    //   // Iterate over predictions and create a div for each prediction
    //   predictions.forEach(({ label, box }) => {
    //     const { xmin, ymin, xmax, ymax } = box;
    //     console.log(box)
