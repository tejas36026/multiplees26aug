self.onmessage = function(e) {
    ...
    try {
        ...
        self.postMessage({
            imageData: result.segmentedImageData,
...
// self.onmessage = function(e) {
//     const { imageData, effectName, frameCount, segmentIndex } = e.data;
    
//     // Process the image data here
//     // For this example, let's just create a simple processed frame
